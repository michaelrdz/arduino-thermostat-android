...
public class historial_temperatura extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_historial_temperatura);
        ...
        registros=(ArrayList)intent.getParcelableArrayListExtra("listTemp");
    ...
    private void createCharts() {
        lineChart=(LineChart)getSameChart(lineChart, "Historial Temperatura", Color.BLUE, Color.YELLOW, 3000,true);
